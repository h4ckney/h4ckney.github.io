        ...
        <div>
            ...
            <div style={{width: '60%', margin: '0 20%'}}>
                <div style={{display: 'flex', flexWrap: 'wrap'}}>
                    ...
                    <StudyBox Title={'스코프와 클로저'} Description={'프론트엔드의 공부'} Tag={['TDZ', '스코프', '클로저']}/>
                    <StudyBox Title={'실행 컨텍스트'} Description={'프론트엔드의 공부'} Tag={['실행 컨텍스트']}/>
                    <StudyBox Title={'브라우저 랜더링 과정'} Description={'프론트엔드의 공부'} Tag={['브라우저 랜더링','렌더러 프로세스']}/>
                    <StudyBox Title={'좋은 테스트와 테스트 방식들'} Description={'프론트엔드의 공부'}/>
                    <StudyBox Title={'프론트엔드에 좋은 책과 기술 영상들'} Description={'프론트엔드의 공부'}/>
                </div>
            </div>
        </div>
    );
